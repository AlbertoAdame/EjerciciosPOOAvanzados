		...
		do {
			...
			case 1:
				...
				if (numVehiculos < MAX_VEHICULOS) {
					String matricula = leerString("Dame la matr�cula: ");
					...
					if (!encontrado) {
						...
						if (tipo.equalsIgnoreCase("coche")) {
							...
							double peso = leerDouble("Dame el peso m�ximo: ");

							Furgoneta f = new Furgoneta(matricula, gama, LocalDate.parse(fechaSalida), peso);
							...
							System.out.println("Este veh�culo no existe");
					}
